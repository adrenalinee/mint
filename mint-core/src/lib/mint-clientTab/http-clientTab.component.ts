...
import { RequestView, NameValue } from '../mint-client/RequestViews';
import { RequestExpansion } from '../mint-client/RequestExpansions';
import { HttpClientConfig } from '../mint-client/HttpClientConfig';
import { HttpClientTabPreference, DefinedRequestInfo } from './HttpClientTabPreferences';
import { DefaultRequestExpansionBuilder } from '../mint-client/expansions/DefaultRequestExpansionBuilder';
 ...
 */
@Component({
  selector: 'app-http-client-tab',
  templateUrl: './http-clientTab.component.html',
  styleUrls: ['./http-clientTab.component.css'],
  // providers: [HttpClientExpansionService]
})
export class HttpClientTabComponent implements OnInit {
  @Input() preference?: HttpClientTabPreference;
  ...
  ngOnInit() {
    if (this.preference == null) {
      //TODO 기본 설정을 사용
      this.preference = new HttpClientTabPreference();
